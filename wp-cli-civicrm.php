...
class CiviCRM_Command extends WP_CLI_Command {
  ...
  /**
   * Implementation of command 'version-code'.
   *
   * @since 1.0.0
   */
  private function versionCode() {
    civicrm_initialize();
  ...
  /**
   * Implementation of command 'version-db'.
   *
   * @since 1.0.0
   */
  private function versionDB() {
    civicrm_initialize();
